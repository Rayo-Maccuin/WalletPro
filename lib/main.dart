...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final String _adminDocument = '123456789';
  ...
  Future<void> _validateAndSubmit() async {
    ...
    if (!_showDocumentError && !_showPasswordError) {
      try {
        ...
        if (_documentController.text == _adminDocument &&
        ...
        // Find user with matching document and password
        ...
        if (isValidUser) {
          // Save current user document for quick access
