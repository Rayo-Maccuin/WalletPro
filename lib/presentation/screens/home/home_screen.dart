...
import 'package:testapp/presentation/formulas/gradient_geometric_screen.dart';
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _buildFinancialOption(
                        ...
                        description:
                            'Calcula series de pagos con incrementos constantes',
                        onTap: () {
                          Navigator.pop(context);
                          Navigator.push(
                            context,
                      ...
                      _buildFinancialOption(
                        ...
                        description:
                            'Calcula series de pagos con incrementos geométricos',
                        onTap: () {
                          Navigator.pop(context);
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder:
                                  (context) => const GeometricGradientScreen(),
                            ),
                          );
                        },
                      ),
                      ...
                      _buildFinancialOption(
                        ...
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const IRRCalculator(),
                            ),
                          );
                        },
                      ),
                      _buildFinancialOption(
                        icon: Icons.savings,
                        title: 'Sistema de Capitalización',
                        description: 'Calcula el sistema de capitalización',
                        onTap: () {
                          Navigator.pop(context);
                          Navigator.push(
                            context,
